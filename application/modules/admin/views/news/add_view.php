           <div class="formPanel big">
            ...
            <fieldset>
                ...
                <form action="<?php echo base_url()."admin/news/add"; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <label>News Title :</label><input type="text" id="txttitle" name="txttitle" size="40" /><br />
                    <label>News Author :</label><input type="text" id="txtau" name="txtau" size="40" /><br />
                    <label>News Info :</label><textarea name="txtinfo" cols="45" rows="4"></textarea><br />
                    <label>News Detail :</label><textarea name="txtdetail" cols="45" rows="15"></textarea><br />
